      ...
      let
        ...
        tascam-mixer = pkgs.rustPlatform.buildRustPackage {
          ...
          postInstall = ''
            ...
            installShellCompletion --cmd tascamctl \
              --bash <($out/bin/tascamctl completions bash) \
              --fish <($out/bin/tascamctl completions fish) \
              --zsh  <($out/bin/tascamctl completions zsh)

            # Desktop entry for the GUI.
            install -Dm644 packaging/tascam-mixer.desktop \
              $out/share/applications/tascam-mixer.desktop
